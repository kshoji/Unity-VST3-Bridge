...
namespace jp.kshoji.unity.vst3nativehost.mcp.runtime
{
    public partial class Tool_VstHost
    {
        ...
        [Description(
            ...
            "Play Mode / runtime required for audible Process. Mode: Instrument (default) or Effect. " +
        ...
        )
        {
            ...
            {
                if (!TryRequireAudioSession("vst3-setup-audio-filter", out var playErr))
                    return playErr!;
        ...
        [Description(
            ...
            "Play Mode / runtime recommended. Does not destroy the GameObject.")]
