...
namespace jp.kshoji.unity.vst3nativehost.mcp.runtime
{
    public partial class Tool_VstHost
    {
        [AiTool(
            ...
            ReadOnlyHint = true)]
        [Description(
            "List VST3 parameters for a loaded plugin. " +
            "preferAutomate=true lists CanAutomate continuous params first.")]
        ...
        [AiTool(
            ...
            ReadOnlyHint = true)]
        [Description("Get a normalized parameter value by paramId and/or title substring.")]
        ...
        [Description(
            "Set a normalized parameter (0–1). Audible effect usually needs Play Mode / running build + audio path.")]
        ...
        )
        {
            return MainThread.Instance.Run(() =>
            {
                ...
                return
                    ...
                    $"title={info.Title} value={readBack:0.######} session={jp.kshoji.unity.vst3nativehost.mcp.core.McpExecutionContext.SessionKind}";
            });
        }
    }
}
