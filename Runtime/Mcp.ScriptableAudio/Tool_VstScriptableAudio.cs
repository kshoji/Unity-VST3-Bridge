...
namespace jp.kshoji.unity.vst3nativehost.mcp.scriptableaudio
{
    ...
    {
        internal const string DefaultObjectName = "__VstHostMcpSa";
        ...
        [Description(
            ...
            "Play Mode / runtime required for audible Process. Prefer vst3-dsp-midi-schedule for timed notes.")]
        ...
        )
        {
            ...
            {
                if (!VstHostToolHelpers.TryRequireAudioSession("vst3-sa-generator-setup", out var sessionErr))
                    return sessionErr!;
                if (pluginId < 1)
